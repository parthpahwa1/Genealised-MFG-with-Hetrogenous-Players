...
class EpisodesBufferEntry:
    ...
    def append(self, view, feature, action, reward, alive, prob=None, prob0=None,  prob1=None, type0_state=None, type1_state=None):
...
class AgentMemory(object):
    def __init__(self, obs_shape, feat_shape, act_n, max_len, use_mean=False, use_dominant=False):
        ...
        if self.use_mean:
            ...
            self.type0_state0 = MetaBuffer(obs_shape, max_len)
            self.type0_state1 = MetaBuffer(feat_shape, max_len)

            self.type1_state0 = MetaBuffer(obs_shape, max_len)
            self.type1_state1 = MetaBuffer(feat_shape, max_len)



    def append(self, obs0, feat0, act, reward, alive, prob=None, prob0=None,  prob1=None, type0_state=None, type1_state=None):
