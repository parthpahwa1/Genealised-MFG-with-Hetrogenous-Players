...
def get_config(map_size):
    ...
    agent = cfg.register_agent_type(
        ...
        attr={'width': 1, 'length': 1, 'hp': 3, 'speed': 3,
              ...
              'step_reward': -0.05,  'dead_penalty': -2, 'attack_penalty': -0.1,
              'attack_in_group': 1})
    ...
    cfg.add_reward_rule(gw.Event(a, 'kill', b), receiver=a, value=2)
 
    cfg.add_reward_rule(gw.Event(b, 'kill', b), receiver=a, value=-1)
    cfg.add_reward_rule(gw.Event(b, 'kill', a), receiver=b, value=2)
