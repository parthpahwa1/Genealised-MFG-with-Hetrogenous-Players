...
def get_config(map_size):
    ...
    agent = cfg.register_agent_type(
        ...
        {'width': 1, 'length': 1, 'hp': 10, 'speed': 2,
         ...
         'step_reward': -0.01,  'kill_reward': 0, 'dead_penalty': -2., 'attack_penalty': -0.25,
         })
    ...
    cfg.add_reward_rule(gw.Event(a, 'attack', a), receiver=a, value=-1)
    cfg.add_reward_rule(gw.Event(a, 'attack', b), receiver=a, value=1)
    cfg.add_reward_rule(gw.Event(b, 'attack', a), receiver=b, value=1)
    cfg.add_reward_rule(gw.Event(b, 'attack', b), receiver=a, value=-1)

    cfg.add_reward_rule(gw.Event(b, 'kill', b), receiver=a, value=-5)
    cfg.add_reward_rule(gw.Event(a, 'kill', a), receiver=a, value=-5)
