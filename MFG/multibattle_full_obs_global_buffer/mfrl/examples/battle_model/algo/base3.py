...
class FullObserve_ValueNet:
    ...
    def _construct_net(self, active_func=None, reuse=False):
        ...
        h_obs = tf.layers.dense(flatten_obs, units=1024, activation=active_func,name="Dense-Obs")
        ...
        h_emb = tf.layers.dense(self.feat_input, units=128, activation=active_func, name="Dense-Emb", reuse=reuse)
        ...
        dense2_dropout = tf.layers.dropout(dense2, rate = 0.25, name="Dense2-dropout" )

        dense3 = tf.layers.dense(dense2_dropout, units=1024, activation=active_func, name="Dense3")
        dense3_dropout = tf.layers.dropout(dense3, rate = 0.25, name="Dense3-dropout" )
