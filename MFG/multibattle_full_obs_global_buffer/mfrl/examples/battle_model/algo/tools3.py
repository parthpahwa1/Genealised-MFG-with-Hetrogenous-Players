...
class EpisodesBufferEntry:
    ...
    def append(self, view, feature, action, reward, alive, prob0=None,  prob1=None, type0_state=None, type1_state=None):
...
class AgentMemory(object):
    ...
    def append(self, obs0, feat0, act, reward, alive, prob0=None,  prob1=None, type0_state=None, type1_state=None):
