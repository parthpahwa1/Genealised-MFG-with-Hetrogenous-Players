...
if __name__ == '__main__':
    ...
    models = [
        spawn_ai(args.algo, sess, env, handles[0], args.algo + '-dom1', args.max_steps, isDom=True),
        spawn_ai(args.algo, sess, env, handles[1], args.algo + '-dom2', args.max_steps, isDom=True),
        spawn_ai(args.algo, sess, env, handles[2], args.algo + '-passive1', args.max_steps, isDom=False), 
        spawn_ai(args.algo, sess, env, handles[3], args.algo + '-passive2', args.max_steps, isDom=False)
    ]
