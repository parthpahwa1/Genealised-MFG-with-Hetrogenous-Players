...
if __name__ == '__main__':
    ...
    with open('multigather_{0}.csv'.format(args.algo), 'w+') as myfile:
    ...
    models = [
        spawn_ai(args.algo, sess, env, handles[0], args.algo + '-type0', args.max_steps),
        spawn_ai(args.algo, sess, env, handles[1], args.algo + '-type1', args.max_steps),
        spawn_ai(args.algo, sess, env, handles[2], args.algo + '-type2', args.max_steps),
        spawn_ai(args.algo, sess, env, handles[3], args.algo + '-type3', args.max_steps)
    ]
    ...
    for k in range(start_from, start_from + args.n_round):
        ...
        with open('multigather_{0}.csv'.format(args.algo), 'a') as myfile:
