...
if __name__ == '__main__':
    ...
    parser.add_argument('--gmfqp', type=int, choices={0,1,2,3}, default=1, help='set the position of GenQ_MF')
    ...
    models = [spawn_ai(args.algo, sess, env, handles[1], args.algo + '-type0', args.max_steps), spawn_ai(args.oppo1, sess, env, handles[2], args.oppo1 + '-type1', args.max_steps)]
    ...
    runner = tools.Runner(sess, env, handles, args.map_size, args.max_steps, models, battle, mtmfq_position, GenQ_MFG_position, render_every=0)
    win_cnt = {'main': 0, 'opponent1': 0}
    total_rewards = []
    ...
    print('\n[*] >>> WIN_RATE: [{0}] {1} / [{2}] {3} '.format(args.algo, win_cnt['main'] / args.n_round, args.oppo1, win_cnt['opponent1'] / args.n_round))
